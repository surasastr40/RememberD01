...
public class MainActivity extends AppCompatActivity {
    ...
    private static final String connstr_query = "http://192.168.1.100/Android_Query/get_query.php";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.GET, connstr_query,
                    ...
                    public void onResponse(String response) {
                        try {
                            ...
                            for (int i =0;i <array.length();i++){
                                ...
                                play.getInt("id_rmmb");
                                Log.d("asdasdasd",play.getString("activity"));
